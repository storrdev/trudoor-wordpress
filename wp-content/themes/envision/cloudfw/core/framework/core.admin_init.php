...
function cloudfw_admmin_scripts(){
	...
	wp_enqueue_script('cloudfw-asmselect', TMP_ADMIN . '/js/jquery.asmselect.js', array('jquery'), cloudfw_get_combined_version());
	if ( cloudfw_is_wpseo() ){
		wp_enqueue_script('cloudfw-seo', TMP_ADMIN . '/js/seo.js', array('jquery'), cloudfw_get_combined_version(), true);
	}
}
