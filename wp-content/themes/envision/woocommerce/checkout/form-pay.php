...
<form id="order_review" method="post">
	...
	<div id="payment">
		...
		<div class="form-row">
			...
			<?php echo apply_filters( 'woocommerce_order_button_html', '<button type="submit" class="btn btn-block '. esc_attr( cloudfw_make_button_style( cloudfw_get_option('woocommerce_button_color', 'place_order', 'btn-primary'), true ) ) .'" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" >' . esc_attr( $order_button_text ) . '</button>' ); ?>
