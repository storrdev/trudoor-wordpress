...
<div id="product-reviews"><?php
	...
	if ( get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || wc_customer_bought_product( '', get_current_user_id(), $product->id ) ) :
		...
		$comment_form = array(
			'title_reply' => have_comments() ? __( 'Add a review', 'woocommerce' ) : __( 'Be the first to review &ldquo;%s&rdquo;', 'woocommerce' ) . ' &ldquo;' . get_the_title() . '&rdquo;',
